...
namespace ConversationsRaiseSpeechcraft
{
    public partial class Program
    {
        ...
        public static void RunPatch(IPatcherState<ISkyrimMod, ISkyrimModGetter> state)
        {
            ...
            records = [.. records.Where(r => r.Quest.FormKeyNullable is not null && !QuestEditorIDExclusions.Any(exclusion => r.Quest.Resolve(cache).EditorID?.Contains(exclusion, StringComparison.OrdinalIgnoreCase) is true))];
